    ...
    itens: [
      {
        ...
        label: "Ver clientes",
        descricao: "Listar e abrir cadastros de clientes.",
      },
      {
        permissao: "clientes.criar",
        label: "Criar cliente",
        descricao: "Cadastrar novos clientes com login.",
      },
      {
        permissao: "clientes.editar",
        label: "Editar cliente",
        descricao: "Alterar dados, plano e serviço extra.",
      },
      {
        permissao: "clientes.excluir",
        label: "Excluir cliente",
        descricao: "Remover o cliente e o login dele.",
      },
    ],
  },
  {
    ...
    itens: [
      {
        ...
        descricao: "Listar vendedores e comissões.",
      },
      {
        permissao: "vendedores.criar",
        label: "Criar vendedor/admin",
        descricao: "Cadastrar novos acessos internos.",
      },
      {
        permissao: "vendedores.editar",
        label: "Editar vendedor/admin",
        descricao: "Alterar dados e comissão.",
      },
      {
        permissao: "vendedores.excluir",
        label: "Excluir vendedor/admin",
        descricao: "Remover acessos internos.",
      },
    ],
  },
  {
    ...
    itens: [
      {
        ...
        descricao: "Criar, editar e desativar planos.",
      },
      {
        permissao: "pagamentos.ler",
        label: "Ver pagamentos",
        descricao: "Consultar cobranças e histórico.",
      },
      {
        permissao: "pagamentos.editar_status",
        label: "Alterar status de pagamento",
        descricao: "Marcar como pago ou simulação.",
      },
      {
        permissao: "cupons.gerenciar",
        label: "Gerenciar cupons",
        descricao: "Criar, bloquear e acompanhar cupons de desconto.",
      },
      {
        permissao: "asaas.sincronizar",
        label: "Sincronizar Asaas",
        descricao: "Gerar cobrança e reprocessar a fila.",
      },
    ],
  },
  {
    ...
    itens: [
      {
        ...
        descricao: "Chave Asaas, webhook e ajustes gerais.",
      },
      {
        permissao: "novidades.gerenciar",
        label: "Gerenciar novidades",
        descricao: "Publicar comunicados e novidades.",
      },
      {
        permissao: "auditoria.ler",
        label: "Ver auditoria",
        descricao: "Consultar o histórico de alterações.",
      },
    ],
  },
];
