...
export type Database = {
  ...
  public: {
    ...
    Enums: {
      ...
      reuniao_status: "marcada" | "realizada" | "remarcada" | "no_show" | "cancelada";
      tarefa_origem: "plano" | "solicitacao_cliente" | "manual";
      tarefa_prioridade: "baixa" | "media" | "alta";
      tarefa_status: "aberta" | "em_andamento" | "concluida" | "cancelada" | "aguardando_cliente";
    };
    CompositeTypes: {
      [_ in never]: never;
    };
...
export const Constants = {
  public: {
    Enums: {
      ...
      lead_origem: ["prospeccao_ativa", "indicacao", "inbound", "evento", "rede_social", "outro"],
      pagamento_status: ["pago", "pendente", "vencido", "simulacao"],
      reuniao_status: ["marcada", "realizada", "remarcada", "no_show", "cancelada"],
      tarefa_origem: ["plano", "solicitacao_cliente", "manual"],
      tarefa_prioridade: ["baixa", "media", "alta"],
